    ...
    $.fn.uploadFile = function (options) {
	   ...
	   this.startUpload = function () {
        ...
        function setDragDropHandlers(obj, s, ddObj) {
            ddObj.live('dragenter', function (e) {
                e.stopPropagation();
                e.preventDefault();
                $(this).addClass(s.dragDropHoverClass);
            });
            ddObj.live('dragover', function (e) {
                e.stopPropagation();
                e.preventDefault();
                var that = $(this);
            ...
            ddObj.live('dragleave', function (e) {
                $(this).removeClass(s.dragDropHoverClass);
            });

            $(document).live('dragenter', function (e) {
                e.stopPropagation();
                e.preventDefault();
            });
            $(document).live('dragover', function (e) {
                e.stopPropagation();
                e.preventDefault();
                var that = $(this);
